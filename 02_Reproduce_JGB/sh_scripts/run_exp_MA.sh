...
echo "Usage: bash sh_scripts/run_exp_MA.sh [USE_NBODY](optional)"
...
echo
echo "Start evolution with gyrFalcON for 13.7 Gyr for: M & A"
...
python stat.py \
  --nemo-files snap_mu10.0_s1.5_sigma0.954_r10.0_N20000/out.nemo \
  --n-timestamps 100 > snap_mu10.0_s1.5_sigma0.954_r10.0_N20000/timestamps_gyrfalcon.txt

python stat.py \
  --nemo-files snap_mu10.0_s1.5_sigma0.954_r10.0_N20000/out.nemo \
  --n-timestamps 10 >> snap_mu10.0_s1.5_sigma0.954_r10.0_N20000/timestamps_gyrfalcon.txt
