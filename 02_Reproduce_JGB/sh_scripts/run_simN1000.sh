...
#   etai=0.001 \
#   etar=0.001 \
#   outdir=snap_mu0.0_s1.0_sigma1.5_r10.0_N1000/runbody2_eta1e-3

# u3tos snap_mu0.0_s1.0_sigma1.5_r10.0_N1000/runbody2_eta1e-3/OUT3 \
#   snap_mu0.0_s1.0_sigma1.5_r10.0_N1000/runbody2_eta1e-3/OUT3.snap
